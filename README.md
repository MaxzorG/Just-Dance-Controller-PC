...
- **Android:** It is highly recommended to use **Firefox**. If you use Chrome based browsers, you may need to enable specific flags for "insecure origins" to allow accelerometer access. (I'm not sure if this works for everyone, I would still recommend use Firefox)
